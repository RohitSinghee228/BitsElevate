export default function BitsElevateForBusiness() {
    return (
        <div className="udemyForBusiness h-96 relative flex justify-center items-center my-10">
          ...
          <div className="contentDiv w-96 text-left text-slate-600 z-10 mt-20 mr-20">
            <h2 className="heading text-3xl mb-4">BitsElevate for Business</h2>
            <p className="about text-lg">
              Get unlimited access to 4,000+ of BitsElevate's top courses for your team.
            </p>
